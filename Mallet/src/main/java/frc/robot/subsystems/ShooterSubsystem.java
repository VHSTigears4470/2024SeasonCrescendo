...
public class ShooterSubsystem extends SubsystemBase {
  ...
  public ShooterSubsystem() {
    //top motor & encoder
    m_topMotor = new CANSparkMax(ShooterConstants.TOP_MOTOR, MotorType.kBrushless);
    topEncoder = m_topMotor.getEncoder();
    m_topMotor.setIdleMode(IdleMode.kBrake);
    m_topMotor.setInverted(false);
    topEncoder.setPosition(0);
    //bottom motor & encoder
    m_bottomMotor = new CANSparkMax(ShooterConstants.BOTTOM_MOTOR, MotorType.kBrushless);
 ...
 //                                                                                                                                                                                              LoBOTTOMy ( sorry i came up with this pun cause of my neighbor, they really love their loBOTTOMies ).
