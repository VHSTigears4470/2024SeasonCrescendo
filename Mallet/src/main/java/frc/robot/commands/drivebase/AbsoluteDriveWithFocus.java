 ...
 */
public class AbsoluteDriveWithFocus extends CommandBase
{
     ...
     * @param isOpenLoop
     */
    public AbsoluteDriveWithFocus(Drivetrain swerve, DoubleSupplier vX, DoubleSupplier vY, boolean isOpenLoop, String focusObject)
    {
        this.swerve = swerve;
        this.vX = vX;
        this.vY = vY;
    ...
    public void execute()
    {
        // Grabs the heading error from the network table and uses it to create a direction to go to 
