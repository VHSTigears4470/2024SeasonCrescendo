...
public class ShootAmpPosition extends SequentialCommandGroup {
        public ShootAmpPosition(IntakeSubsystem intakeSubsystem, ElevatorSubsystem elevatorSubsystem) {
