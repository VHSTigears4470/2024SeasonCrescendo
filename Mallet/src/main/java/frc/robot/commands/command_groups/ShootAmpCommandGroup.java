...
public class ShootAmpCommandGroup extends SequentialCommandGroup {
    public ShootAmpCommandGroup(IntakeSubsystem intakeSubsystem, ElevatorSubsystem elevatorSubsystem) {
