...
public class AmpPositionCommandGroup extends SequentialCommandGroup {
    public AmpPositionCommandGroup(IntakeSubsystem intakeSubsystem, ElevatorSubsystem elevatorSubsystem) {
        addCommands(
                // Ignoring 1st & 2nd
